...
The phase transition is one of the most important concept in materials science. Phenomenologically, we may describe the kinetics of phase transitions with the phase field model in the framework of Ginzburg-Landau theory. The phase-field equation (Allen-Cahn) dictates that the temporal evolution of the phase field can be described by the partial-differential equation below,
